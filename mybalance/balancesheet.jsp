    ...
    <table id = "t1" align = "center">
    	<tr>
    		<td>
    			...
    			<a href="${pageContext.request.contextPath }/findrecord.jsp">查找记录</a>&nbsp;
    			<a href="${pageContext.request.contextPath }/visualrecord.jsp">数据视图</a>&nbsp;
    		</td>
    	</tr>
    	<tr>
    		<td>
    			<table width = "100%" id = "t2">
    				...
    				<c:choose>
    					<c:when test="${empty balanceSheet }">
    						<tr>
    							<td colspan="8" align="center">没有数据</td>
    						</tr>
    					</c:when>
	    				<c:otherwise>
	    					<c:forEach items="${balanceSheet }" var="record">
	    						<tr>
